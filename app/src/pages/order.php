...
if ($orderId > 0) {
  ...
  <?php if (empty($orders)): ?>
    <div class="alert alert-info">You haven't placed any orders yet. <a href="?page=shop">Start shopping →</a></div>
  <?php else: ?>
  <table class="admin-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="?page=order&id=<?= (int) $o['id'] ?>" class="btn btn-secondary btn-sm">View</a></td>
      </tr>
      <?php endforeach ?>
    </tbody>
  </table>
