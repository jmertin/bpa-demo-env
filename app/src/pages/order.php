...
if ($orderId > 0) {
  ...
  <div style="text-align:center;margin-top:1.5rem">
    <a href="<?= page_url('shop') ?>" class="btn btn-primary">Continue shopping</a>
  </div>
  ...
  <?php if (empty($orders)): ?>
    <div class="alert alert-info">You haven't placed any orders yet. <a href="<?= page_url('shop') ?>">Start shopping →</a></div>
  <?php else: ?>
  <table class="admin-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?= page_url('order', ['id' => (int) $o['id']]) ?>" class="btn btn-secondary btn-sm">View</a></td>
      </tr>
      <?php endforeach ?>
    </tbody>
  </table>
