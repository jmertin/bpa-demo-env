...
```bash
REGISTRY / REGISTRY_USER / REGISTRY_PASSWORD # If using Kubernetes only!
IMAGE_PREFIX / IMAGE_TAG
MARIADB_ROOT_PASSWORD / MARIADB_DATABASE / MARIADB_USER / MARIADB_PASSWORD
APP_NAMESPACE / APP_HOSTNAME / TLS_CLUSTER_ISSUER / INGRESS_CLASS_NAME / KUBECONFIG # If using Kubernetes only!
```
